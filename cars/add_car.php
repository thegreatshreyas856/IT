      ...
      <form action="updatecar.php" Method="POST" enctype="multipart/form-data">
        <div class="w3-row-padding" style="margin:0 -16px;">
          ...
          <div class="w3-half">
            ...
            <input class="w3-input w3-border" type="text" placeholder="reg-number" name="reg_number" required>
          </div>
          <div class="w3-half">
            <label>Price</label>
            ...
            <div class="w3-half">
            <label>Phone</label>
            <input class="w3-input w3-border" type="number" placeholder="Enter phone number" name="phone" required>
          </div>
          <div class="w3-half">
            <label>Owner</label>
            <input class="w3-input w3-border" type="text" placeholder='<?php echo "$user";  ?>'  name="owner" disabled>
          </div>
          <div class="w3-half">
